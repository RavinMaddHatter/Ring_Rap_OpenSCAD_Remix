...
module rim_profile_fit_sample(rim_shape="Nucleon_Front"){
	difference(){
		hull(){
			translate([5,0,0])linear_extrude(10)import(file = "Rim_cross_section.dxf",layer=rim_shape);	
			translate([-5,0,0])linear_extrude(10)import(file = "Rim_cross_section.dxf",layer=rim_shape);	
			translate([0,-5,0])linear_extrude(10)import(file = "Rim_cross_section.dxf",layer=rim_shape);	
		}
		linear_extrude(10)import(file = "Rim_cross_section.dxf",layer=rim_shape);
