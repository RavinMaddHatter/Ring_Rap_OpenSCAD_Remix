...
module top_pillar_mount(location_angle,bevel_radius=5){
	rotate([0,0,-90])difference(){
		hull(){
			rotate([0,0,90-location_angle])translate([iso_rim_size/2-rim_distance_from_bead_to_inner_circle-pillar_support_wall_thickness-pillar_rod_diameter/2,0,pillar_support_wall_thickness+rim_width/2-length_of_top_support])cylinder(r=pillar_rod_diameter/2+pillar_support_wall_thickness, h=length_of_top_support);
